    ...
    public ArrayList<String> addReplique(String nom){
        ...
        switch (nom) {
            ...
            case "moine":
                ...
                break;
            case "spectre":
            	lines.add("Pour pouvoir continuer tu dois sois faire 5000 pas ou visionner une pub en cliquant sur le panneau");
            	break;
            case "vieux":
            ...
            case "luigi":
                ...
                break;
            case "panneau":
                lines.add("Salut a toi jeune entreprenueur(pub)");
                break;
            case "épouvantail":
